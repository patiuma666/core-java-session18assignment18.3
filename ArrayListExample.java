/*
 * creating am ArrayList class  and Showing the functions how it performs 
 */

package assignment18; // creating a package name as assignment18
...
public class ArrayListExample {   //creating the class name as ArraListExample
	...
	public static void main(String[] args) { //creating main method 
		...
		ArrayList <Integer> studentMarks =new  ArrayList<Integer>(); //here I'm creating an array list of student marks of type integer 
		 ...
		 studentMarks.add (88); //creating the list objects and initializing the variables  in it 
		 studentMarks.add (99);
		 studentMarks.add (53);
		 studentMarks.add (66);
		 studentMarks.add (72);
